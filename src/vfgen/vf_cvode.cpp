...
void VectorField::PrintCVODE(map<string,string> options)
    ...
    if (options.count("version") > 0 && options["version"] != "2.3.0" && options["version"] != "2.4.0" && options["version"] != "2.5.0")
        {
        cerr << "vfgen CVODE command: unknown version specified: " << options["version"] << endl;
        cerr << "Versions of CVODE supported by VFGEN are 2.3.0, 2.4.0 and 2.5.0. Default: version=2.5.0" << endl;
        exit(-1);
        } 
