...
int help(char *command)
    ...
    if (strcmp(command,"adolc") == 0)
        ...
        cout << endl;
        cout << "Options: (default is listed first)\n";
        cout << "version=2.5.0|2.4.0|2.3.0\n";
	...
	else if (strcmp(command,"cvodes") == 0)
	{
        cout << "use: vfgen cvodes vector_field_file.vf\n";
        cout << "     vfgen cvodes:option=value,...,option=value vector_field_file.vf\n";
        cout << endl;
        cout << "This command generates code to be used with the CVODES library (which is part\n";
        cout << "of the SUNDIALS suite).\n";
        cout << "With no options, two files are created:\n";
        cout << "    [name]_cvs.c\n";
        cout << "    [name]_cvs.h\n";
        cout << "where [name] is the Name attribute of the VectorField entity in the vector\n";
        cout << "field file.  The file [name]_cvs.c will define the C functions [name]_vf() and\n";
        cout << "[name]_jac().\n";
        cout << endl;
        cout << "Options: (default is listed first)\n";
        cout << "version=2.6.0\n";
        ...
        cout << "func=no|yes\n";
        cout << "    By default, any user function defined in the vector field file is not\n";
        cout << "    defined in [name]_cvs.c.  If the option func=yes is given, the function\n";
        cout << "    [name]_func() will be defined.  This function will fill in an array with\n";
        cout << "    values that are the user defined functions.\n";
		cout << "sens=no|yes\n";
        cout << "    This option is no by default. It controls the generation of sensitivity \n";
        cout << "    functions in [name]_cvs.c.  If the option sens=yes is given, the function\n";
        cout << "    [name]_sens() will be defined which can be used for Forward Sensitivity\n";
		cout << "    Analysis by the CVodeSensInit1 CVODES method. If any user function is defined\n";
		cout << "    in the vector field file and func=yes then sensitivities for these functions.\n";
		cout << "    are also defined in [name]_func_sens.\n";
        cout << "demo=no|yes\n";
        cout << "    If the option demo=yes is given, two more files are created:\n";
        cout << "        [name]_cvsdemo.c\n";
        cout << "        Makefile-[name]_cvsdemo\n";
        cout << "    where [name] is the Name attribute of the VectorField entity in the\n";
        cout << "    vector field file.  This program provides a simple command-line solver.\n";
        cout << "    It takes arguments in the form name=value, where name can be a state\n";
        cout << "    variable (to give an initial condition), a parameter (to give the value\n";
	...
	else if (strcmp(command,"esens") == 0)
	{
        cout << "use: vfgen esens vector_field_file.vf\n";
		cout << endl;
		cout << "This command generates a new vector field file, in which the original vector\n";
        cout << "field has been extended with its sensitivity equations.\n";
        cout << endl;
        ...
        cout << "    vfgen esens system.vf > system_esens.vf\n";
        cout << endl;
		cout << "Options: (default is listed first)\n";
		cout << "second=no|yes\n";
		cout << "    Also generates second order sensitivity equations.\n";
	}
        ...
        cout << "num=numpy|numeric\n";
        cout << "    Determines which numerical library the Python functions created by VFGEN\n";
        cout << "    use to initialize the vectors or arrays that it computes.\n";
        }
...
int main(int argc, char **argv)
	...
	command_options["cvodes"].push_back("demo");
	command_options["cvodes"].push_back("func");
	command_options["cvodes"].push_back("sens");
	command_options["cvodes"].push_back("version");
	command_options["esens"].push_back("second");
    ...
    command_options["pygsl"].push_back("num");
    ...
    if (commandstr == "check")
        ...
        if (vf.IsDelay == false)
            ...
            cerr << "Delay equations can not be handled by the " << commandstr << " command.\n";
	else if (commandstr == "cvodes")
		if (vf.IsDelay == false)
			vf.PrintCVODES(options);
		else
			cerr << "Delay equations can not be handled by the " << commandstr << " command.\n";
	else if (commandstr == "esens")
		if (vf.IsDelay == false)
			vf.PrintESENS(options);
		else
			cerr << "Delay equations can not be handled by the " << commandstr << " command.\n";
