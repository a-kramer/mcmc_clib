...
void VectorField::PrintADOLC(map<string,string> options)
    ...
    fout << "#include \"adolc/adouble.h\"\n";
    fout << "#include \"adolc/drivers/odedrivers.h\"\n";
    fout << "#include \"adolc/adalloc.h\"\n";
    // fout << "#include <adolc.h>" << endl;
    fout << endl;
    //
    ...
    fout << "    {" << endl;
    fout << "    adoublev ay_(" << nv << ");" << endl;
    fout << "    adoublev af_(" << nv << ");" << endl;
    fout << endl;
    if (HasPi)
        {
