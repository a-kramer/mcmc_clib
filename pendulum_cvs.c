 ...
 *  Generated on  8-Feb-2017 at 13:35
 */
...
int pendulum_vf(realtype t, N_Vector y_, N_Vector f_, void *params)
    ...
    NV_Ith_S(f_,0) = v;
    NV_Ith_S(f_,1) = -g*sin(theta)/L-v/m*b/(L*L);
    return 0;
    }
...
int pendulum_sens(int Ns_, realtype t, N_Vector y_, N_Vector ydot_,
    ...
    NV_Ith_S(ySdot_,1) = -1.0/m*S1*b/(L*L)-S0*g/L*cos(theta);
...
int pendulum_func(realtype t, N_Vector y_, realtype *func_, void *params)
    ...
    /* energy:  */
    func_[0] =  (v*v)*m*(L*L)/2.0-m*g*L*cos(theta);
    return 0;
    }
...
int pendulum_func_sens(realtype t, N_Vector y_, N_Vector * yS_, double* ret_, void *params)
    ...
    /* g:  */
        ret_[0] =  m*g*sin(theta)*yS_00*L-m*L*cos(theta)+v*m*(L*L)*yS_01;
    /* b:  */
        ret_[1] =  v*m*yS_11*(L*L)+m*g*yS_10*sin(theta)*L;
    /* L:  */
        ret_[2] =  v*m*yS_21*(L*L)-m*g*cos(theta)+(v*v)*m*L+m*g*sin(theta)*L*yS_20;
    /* m:  */
        ret_[3] =  (v*v)*(L*L)/2.0+v*m*yS_31*(L*L)-g*L*cos(theta)+m*g*yS_30*sin(theta)*L;
    return 0;
    }
